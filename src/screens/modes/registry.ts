...
import { registerMode, getModes, getModeById } from '../../extensions/registry';

const LazyPhotoMode = lazy(() => import('./photo/PhotoMode').then(m => ({ default: m.PhotoMode })));
const LazyVideoMode = lazy(() => import('./video/VideoMode').then(m => ({ default: m.VideoMode })));
const LazyLongExposureMode = lazy(() => import('./long-exposure/LongExposureMode').then(m => ({ default: m.LongExposureMode })));
...
export { registerMode, getModes, getModeById };